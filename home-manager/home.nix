  ...
  programs = {
    ...
    bash = {
      ...
      shellAliases = {
        ...
        nix-cleanup-all = "nix-collect-garbage --delete-old";
        nix-cleanup-aggressive = "nix-collect-garbage --delete-older-than 1d";
        nix-cleanup-relaxed = "nix-collect-garbage --delete-older-than 30d";
      };
      profileExtra = ''
