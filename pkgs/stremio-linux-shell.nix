# new stremio-linux-shell, since nixpkgs currently doesn't have it.
# from https://codeberg.org/nuko/walkure/src/commit/36af1fbf5f08e2c20e1c63f51a692daad82ce154/nix/packages/stremio-linux-shell.nix#
{
  lib,
  stdenv,
  rustPlatform,
